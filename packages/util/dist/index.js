...
var FormatWan = function FormatWan(_ref) {
  ...
  if (!v || Number.isNaN(v)) {
    return /*#__PURE__*/React__default['default'].createElement("span", null, v, " is NaN");
  }
  var result = val;

  if (val > 10000) {
    result = Math.floor(val / 10000);
    result = /*#__PURE__*/React__default['default'].createElement("span", null, result, /*#__PURE__*/React__default['default'].createElement("span", {
      style: {
        position: 'relative',
        top: -2,
        fontSize: 14,
...
formatWan.PropTypes = {
  val: PropTypes__default['default'].number.isRequired
};
...
var dateSplit = function dateSplit(data, noTime) {
  ...
  return noTime ? /*#__PURE__*/React__default['default'].createElement("span", null, da) : /*#__PURE__*/React__default['default'].createElement("span", null, da, /*#__PURE__*/React__default['default'].createElement("br", null), time);
};
...
var StoriesDiv = function StoriesDiv(_ref) {
  var child = _ref.child;
      _ref.prop;
  return /*#__PURE__*/React__default['default'].createElement("div", null, child);
};
